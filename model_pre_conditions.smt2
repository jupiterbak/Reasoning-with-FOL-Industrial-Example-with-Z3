...
(assert
(let (($x151 (exists ((o Order) (b Bottle) (c Cap) )(and (isWashed b) (isFilled b) (= (getOrderLiquid o) (getBottleLiquid b)) (= (getBottleLiquidVolume b) (getOrderLiquidVolume o)) (= (getCapMaterial c) (getOrderCapMaterial o)) (= (getCapDiameter c) (getBottleDiameter b))))
))
(let (($x94 (exists ((p Process) )(subProcess p InsertingDIN8580))
))
...
(not (=> (and $x112 $x116) (and $x94 $x151))))))))
(check-sat)
